...
def create_app(**kwargs):
    ...
    df_innovation_, df_domain_, df_questions_, feature_weights, default_feature_weight_id = get_fixed_data(data_dir)
    ...
    df["default_feature_weight_id"] = feature_weights_key
    app.df = df
